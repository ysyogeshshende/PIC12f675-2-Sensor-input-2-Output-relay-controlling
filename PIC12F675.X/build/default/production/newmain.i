...
# 1 "C:/Program Files/Microchip/MPLABX/v6.00/packs/Microchip/PIC10-12Fxxx_DFP/1.5.61/xc8\\pic\\include\\__unsupported.h" 1 3
    ...
    while (1) {
        ...
        if (GP3 == 0) {
            ...
            if (GP3 == 0) {
                ...
                while (count < 4055UL && GP2 == 1u && flag1 == 0u) { count++; _delay((unsigned long)((1)*(4000000/4000.0))); }
                count = 0u;
                flag1 = 1u;
                GP5 = 0;
            }
        ...
        if (GP1 == 0u && flag1 == 1u) {
            ...
            while (count < 1622UL && GP1 == 0u &&GP2==1u && flag1 == 0u) {count++;_delay((unsigned long)((1)*(4000000/4000.0))); }
            if (GP1 == 0u && flag1 == 1u) {
                GP5 = 0;
                GP0 = 1;
                flag1 = 0;
                while (count < 3244UL &&GP2==1u&& flag1 == 0u) {count++; _delay((unsigned long)((1)*(4000000/4000.0)));}
                GP0 = 0;
            }
        }
        ...
        if (GP4 == 0u && flag1 == 1u) {
            ...
            while (count < 2433UL && GP4 == 0u && GP2==1&&flag1 == 0u) {count++;_delay((unsigned long)((1)*(4000000/4000.0)));}
             if (GP4 == 0u && flag1 == 1u) {
                 flag1=0;
                 GP5=0;
             }}
